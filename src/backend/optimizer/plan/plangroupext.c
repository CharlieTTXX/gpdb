...
static void rebuild_append_simple_rel_and_rte(PlannerInfo *root,
											  List *rtable,
											  List *subplans,
											  List *subroots);
static PlannerInfo *add_subroot_for_subqueryscan(PlannerInfo *root);
				  ...
				  int subplan_no)
{
	...
	group_context.canonical_grpsets = NULL;
